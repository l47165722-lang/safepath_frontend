...
/**
 * Sends route status updates to the paired Wear OS watch over the Play
 * Services Wearable Data Layer's DataClient, now that the wear module's
 * applicationId matches the phone module's (see wear/build.gradle.kts).
 *
 ...
 * combination confirmed working real-device + real-device.
 *
